...
<div class="container mt-5">
    ...
    <img src="<?= BASEURL ;?>/img/gbrkimiaxii/ubud.jpg" class="card-img-top rounded mx-auto d-block" alt="" width="300">
        <div class="card-body">
        ...
        <div class="col-11">
            ...
            <p>Materi Pelajaran Matematika</p>
                <?php foreach ($data['pb'] as $pb ): ?>
                    ...
                    <?= $pb['namaMateri'] ;?>
                    <a href="<?= BASEURL ;?>/kimiaxii/hapus/<?= $pb['id']  ?>" class="badge badge-danger float-right ml-1" onclick="return confirm('apakah anda ingin menghapus materi ini?');">Hapus</a>
                    <a href="<?= BASEURL ;?>/kimiaxii/info/<?= $pb['id']  ?>" class="badge badge-success float-right">More Info</a>                    
                    </li>
                <?php endforeach; ?>
            </ul>
            <br>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= BASEURL;  ?>/kimiaxii/tambah" method="post">
