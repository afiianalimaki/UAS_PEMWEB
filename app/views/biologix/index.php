...
<div class="container">
  <div class="row">
    ...
    <div class="row-5">
        <div class="col-11">
            <ul class="list-group">
            <p>Materi Pelajaran Biologi</p>
                <?php foreach ($data['pb'] as $pb ): ?>
                    <li class="list-group-item">
                    <?= $pb['namaMateri'] ;?>
                    <a href="<?= BASEURL ;?>/biologix/hapus/<?= $pb['id']  ?>" class="badge badge-danger float-right ml-1" onclick="return confirm('apakah anda ingin menghapus materi ini?');">Hapus</a>
                    <a href="<?= BASEURL ;?>/biologix/info/<?= $pb['id']  ?>" class="badge badge-success float-right">More Info</a>                    
                    </li>
                <?php endforeach; ?>
            </ul>
            <br>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= BASEURL;  ?>/biologix/tambah" method="post">
