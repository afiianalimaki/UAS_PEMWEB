...
<div class="container mt-5">
    ...
    <img src="<?= BASEURL ;?>/img/gbrfisikax/ubud.jpg" class="card-img-top rounded mx-auto d-block" alt="" width="300">
        <div class="card-body">
...
<div class="container">
  <div class="row">
    ...
    <div class="row-5">
        <div class="col-11">
            <ul class="list-group">
            <p>Materi Pelajaran Fisika</p>
                <?php foreach ($data['pb'] as $pb ): ?>
                    <li class="list-group-item">
                    <?= $pb['namaMateri'] ;?>
                    <a href="<?= BASEURL ;?>/fisikax/hapus/<?= $pb['id']  ?>" class="badge badge-danger float-right ml-1" onclick="return confirm('apakah anda ingin menghapus materi ini?');">Hapus</a>
                    <a href="<?= BASEURL ;?>/fisikax/info/<?= $pb['id']  ?>" class="badge badge-success float-right">More Info</a>                    
                    </li>
                <?php endforeach; ?>
            </ul>
            <br>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= BASEURL;  ?>/fisikax/tambah" method="post">
